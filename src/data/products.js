...
<<<<<<< HEAD
    ...
    short: "IoT Basic Kit",
    tagline:
      "Affordable starter kit for basic IoT and embedded learning.",
    price: 10000,
    oldPrice: 13000,
    color: "#22c55e",
    glow: "34,197,94",
    ...
    badgeColor: "#22c55e",
    overview:
      "The ARC LABS IoT Basic Kit is designed for absolute beginners who want an affordable introduction to Arduino and ESP32 programming with essential sensors and outputs. Plug-and-play layout with all core peripherals pre-wired.",
    controllers: [
    ...
    includes: [
      {
        icon: "🔧",
        name: "Basic Kit Board",
        desc: "Pre-assembled training board",
      },
      {
        icon: "💻",
        name: "Sample Codes",
        desc: "Arduino & ESP32 examples",
      },
      {
        icon: "📋",
        name: "User Manual",
        desc: "Quick start documentation",
      },
      {
        icon: "🎧",
    ...
    useCases: [
      {
        title: "IoT Learning",
        desc: "Perfect for students starting with IoT and embedded systems.",
      },
      {
        title: "Mini Projects",
        desc: "Build simple automation and monitoring systems.",
      },
      {
        title: "School Labs",
        desc: "Ideal for basic electronics and coding practice.",
      },
    ],
    for: [
      "School Students",
